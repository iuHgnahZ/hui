    ...
    public partial class ForceIpDemo : Form
    {
        ...
        private void bnSetIp_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MyCamera.MV_GIGE_DEVICE_INFO stGigEDev = (MyCamera.MV_GIGE_DEVICE_INFO)MyCamera.ByteToStruct(device.stSpecialInfo.stGigEInfo, typeof(MyCamera.MV_GIGE_DEVICE_INFO));
                ...
                device.stSpecialInfo.stGigEInfo = new Byte[Marshal.SizeOf(device.stSpecialInfo)];
                Marshal.Copy(stGigeInfoPtr, device.stSpecialInfo.stGigEInfo, 0, Marshal.SizeOf(device.stSpecialInfo));
