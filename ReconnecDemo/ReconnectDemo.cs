    ...
    public partial class ReconnectDemo : Form
    {
        ...
        private void DeviceListAcq()
        {
            ...
            for (int i = 0; i < m_stDeviceList.nDeviceNum; i++)
            {
                ...
                {
                    IntPtr buffer = Marshal.UnsafeAddrOfPinnedArrayElement(device.stSpecialInfo.stGigEInfo, 0);
                ...
                {
                    IntPtr buffer = Marshal.UnsafeAddrOfPinnedArrayElement(device.stSpecialInfo.stUsb3VInfo, 0);
