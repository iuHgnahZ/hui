    ...
    class ConnectSpecCamera
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                stDevInfo.stSpecialInfo.stGigEInfo = new Byte[Marshal.SizeOf(stDevInfo.stSpecialInfo)];
                Marshal.Copy(stGigeInfoPtr, stDevInfo.stSpecialInfo.stGigEInfo, 0, Marshal.SizeOf(stDevInfo.stSpecialInfo));
